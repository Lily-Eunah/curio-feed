...
public class ArticleDetailServiceImpl implements ArticleDetailService {
    ...
    public ArticleDetailResponse getArticleDetail(UUID id, DifficultyLevel level) {
        ...
        return ArticleDetailResponse.builder()
                ...
                .sourceTitle(article.getSourceTitle())
                .sourcePublisher(article.getSourcePublisher())
                .sourceUrl(article.getSourceUrl())
                .publishedAt(article.getPublishedAt())
                .sourcePublishedAt(article.getSourcePublishedAt())
                .sourceAccessedAt(article.getSourceAccessedAt())
